...
# Date:   15 Oct 2020
# Brief:  Makefile for game.c include all the other source that is used
...
game.o: game.c ../../drivers/avr/system.h ../../drivers/avr/pio.h ../../utils/pacer.h ../../drivers/navswitch.h  ../../drivers/avr/ir_uart.h button.h led.h
	$(CC) -c $(CFLAGS) $< -o $@
